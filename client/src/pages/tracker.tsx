    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex justify-center mb-8">
        <div className="inline-flex rounded-md shadow-sm" role="group">
          <Link href="/results">
            <div className="py-2 px-4 text-sm font-medium text-gray-900 bg-white rounded-l-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-500 cursor-pointer">
              Analysis
            </div>
          </Link>
          <Link href="/tracker">
            <div className="py-2 px-4 text-sm font-medium text-white bg-blue-600 rounded-r-lg border border-blue-600 focus:z-10 focus:ring-2 focus:ring-blue-500 cursor-pointer">
              Track Symptoms
            </div>
          </Link>
        </div>
